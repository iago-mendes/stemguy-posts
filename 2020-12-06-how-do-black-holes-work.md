We live in exciting times for talking about black holes; in a short period of time, humanity has detected the collision of a binary system (proving the existence of gravitational waves), taken the first direct image of a black hole, and proven that the center of our galaxy is one of those objects. If you are excited about this subject – like me – you may have seen this term being used a very often recently.
...
We are so used to thinking about the beginning and ending of things that the first question that usually arises when discussing black holes is about its origin. Well, there are more than one answer.
...
Black holes are very complex objects, being impossible to describe all of their composition details in a short post. Be as it may, below I talk about some of the most interesting aspects about them in my opinion.
...
The details of this process are really complex, but we can try to simplify it. Basically, in quantum mechanics, every particle has a pair – called antiparticle – and they pop in and out of existence all the time. The emission occurs when this process (popping in and out) happen in the boundary of the event horizon; in this scenario, the inner particle falls into the center of the black hole while the other particle escapes from it. This escaping particle is what forms the Hawking radiation, decreasing the mass and energy of the black hole.
